...
})({"9X97Q":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "7c20e639c09717c5";
"use strict";
...
var _selectMjs = require("./select-plugin/select.mjs");
var _selectMjsDefault = parcelHelpers.interopDefault(_selectMjs);
const select = new (0, _selectMjsDefault.default)("#select", {
...
},{"./select-plugin/select.mjs":"8EJ9E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8EJ9E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _selectStyleScss = require("./select_style.scss");
class Select {
    ...
    clickHandlerCloseCombobox(event) {
        ...
        if (type.contains("select") == false) this.close();
    }
    clickHandler(event) {
        const { type  } = event.target.dataset;
        if (type === "select" && this.select.classList.contains("open")) this.close();
        else this.open();
        if (type === "item") {
...
},{"./select_style.scss":"lMwFq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lMwFq":[function() {},{}],"gkKU3":[function(require,module,exports) {
...
},{}]},["9X97Q","kkGe5"], "kkGe5", "parcelRequire94c2")
